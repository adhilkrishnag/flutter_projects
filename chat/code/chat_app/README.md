...
| `lib/core/error/` | Error handling (exceptions, failures) |
| `lib/src/features/auth/` | Authentication feature |
| `lib/src/features/auth/bloc/` | Auth BLoC (events, states, bloc) |
| `lib/src/features/auth/data/` | Auth data sources, repositories |
| `lib/src/features/auth/domain/` | Auth entities, use cases |
| `lib/src/features/auth/presentation/` | Auth UI (wrapper, login screen) |
| `lib/src/features/chat/` | Chat feature |
| `lib/src/features/chat/bloc/` | Chat BLoC (events, states, bloc) |
| `lib/src/features/chat/data/` | Chat data sources, repositories |
| `lib/src/features/chat/domain/` | Chat entities, use cases |
| `lib/src/features/chat/presentation/` | Chat UI (chat screen) |
| `lib/main.dart` | App entry point |
| `web/index.html` | Firebase SDK for web |
